...
public class Client02 {
    private static String url = "https://release.meetingbroker.com/meetingbrokerservices/handler.asmx";
    //端点引用 指接口位置
  ...
  public static void main(String[] args) {
        String action  = "http://localhost/MeetingBrokerServices/ProcessRequest";
        String methodStr = "ProcessRequest";
        String namespace = "http://localhost/MeetingBrokerServices/"; 
        String tns = "xsd";
