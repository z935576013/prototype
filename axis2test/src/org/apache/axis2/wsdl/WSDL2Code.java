...
//    	printUsage();
    	String url="https://release.meetingbroker.com/meetingbrokerservices/handler.asmx?wsdl";
//    	String url="http://localhost:8080/axis2/services/HelloService?wsdl";
//    	String url="http://ws.webxml.com.cn/WebServices/WeatherWS.asmx?wsdl";
		String[] testargs = { "-uri", url ,
				"-p","hotel.gen"
		};
      ...
      if (isJwsOptionEnabled(commandLineOptionParser)){
         new JAXWSCodeGenerationEngine(commandLineOptionParser, testargs).generate();
         return;
      }
