...
public class NotificationStatus implements java.io.Serializable {
    ...
    public static final NotificationStatus Succeeded = new NotificationStatus(_Succeeded);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/MeetingBrokerServices", "NotificationStatus"));
    }
    /**
