...
public class InsertElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
		...
		// TODO oracle自增
		insertClause.append(" <selectKey resultType=\"Long\" keyProperty=\"id\" order=\"BEFORE\" >   SELECT SEQ_"
				+ introspectedTable.getFullyQualifiedTableNameAtRuntime() + ".nextval AS id from dual   </selectKey> \r\n");
